...
void gk()
{
    ...
    case 1:
        ...
        printf("\n\nYou score %d/10 in World Wide General Knowledge\n", score);
...
printf("\nQ1: What is the national language of Pakistan?\n");
        ...
        // Question 8
        printf("\nQ8: What is the name of Pakistan's highest peak?\n");
        ...
        // Question 9
        printf("\nQ9: What is the national sport of Pakistan?\n");
        printf("1: Hockey \n2: Football\n3: Cricket\n4: Squash\n");
        printf("Enter your answer: ");
        scanf("%d", &answer);
        if (answer == 1)
        ...
        // Question 10
        printf("\nQ10: In which year was the first Constitution of Pakistan enacted?\n");
        printf("1: 1947 \n2: 1950\n3: 1956\n4: 1962\n");
        printf("Enter your answer: ");
        scanf("%d", &answer);
        if (answer == 3)
        ...
        printf("\n\nYou score %d/10 in Pakistan's General Knowledge\n", score);
